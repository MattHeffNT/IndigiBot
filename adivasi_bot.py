...
if hasattr(tweet,'retweeted_status')==False and tweet.in_reply_to_screen_name==None and str1 in tweet.text or str1.upper() in tweet.text or str1.title() in tweet.text:                link= "https://twitter.com/user/status/"+tweet.id_str
